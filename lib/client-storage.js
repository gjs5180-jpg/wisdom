export const storageKeys = {
  ...
  routineNote: (slug) => `mindroute:routine-note:${slug}`,
  legacyRoutineNote: (slug) => `wisdom:routine-note:${slug}`,
};
...
export function routineNoteStorageKeys(slug) {
  return [storageKeys.routineNote(slug), storageKeys.legacyRoutineNote(slug)];
}
