...
const copyByLocale = {
  ja: {
    ...
    koreanMap: "韓国語の基準地図",
    searchPlaceholder: "人間関係、別れ、燃え尽き、自己肯定感、勉強...",
  ...
  zh: {
    ...
    koreanMap: "韩语基准地图",
    searchPlaceholder: "讨好型人格、分手、倦怠、自尊、学不进去...",
    searchAria: "搜索中文预览",
    suggested: "推荐",
  ...
  es: {
    ...
    searchPlaceholder: "ruptura, burnout, baja autoestima, no puedo estudiar...",
  ...
  fr: {
    ...
    searchPlaceholder: "rupture, burnout, faible estime de soi, je n'arrive pas à étudier...",
  ...
  de: {
    ...
    searchPlaceholder: "Trennung, Burnout, geringes Selbstwertgefühl, nicht lernen können...",
